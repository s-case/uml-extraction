...
import eu.scasefp7.eclipse.umlrec.ui.papyrus.DiagramManager;
import eu.scasefp7.eclipse.umlrec.ui.papyrus.PapyrusModelCreator;
import eu.scasefp7.eclipse.umlrec.ui.papyrus.utils.EditPartFinder;
...
public class PapyrusModifier {
	...
	public PapyrusModifier(String projectName, String modelName){
		...
		if(papyrusModelCreator.diExists()){
			editor = EditorUtils.openPapyrusEditor(papyrusModelCreator.getDi());
